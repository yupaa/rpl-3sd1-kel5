...
<div class="p-4 sm:ml-64 mt-16">
    ...
    <div class="bg-yellow-400 rounded-lg shadow-lg p-5 w-full">
      ...
      <!-- Form Body -->
      <form class="mx-auto">
        <textarea id="message" rows="8" class="flex p-4 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Kritik dan Saran"></textarea>
        <br>
